...
func (ContactVerification) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("kind").Values("email", "phone", "password_reset"),
...
func (AccountabilityGroup) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("join_code_hint").Default(""),
		field.String("join_code_encrypted").Default("").Sensitive(),
...
func (SupportMessage) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("author_role").Values("requester", "admin"),
