...
func (_u *OrganizationUpdate) SetRetentionPolicyJSON(v map[string]interface{}) *OrganizationUpdate {
	_u.mutation.SetRetentionPolicyJSON(v)
	return _u
}

// ClearRetentionPolicyJSON clears the value of the "retention_policy_json" field.
func (_u *OrganizationUpdate) ClearRetentionPolicyJSON() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.RetentionPolicyJSON(); ok {
		_spec.SetField(organization.FieldRetentionPolicyJSON, field.TypeJSON, value)
	}
	if _u.mutation.RetentionPolicyJSONCleared() {
		_spec.ClearField(organization.FieldRetentionPolicyJSON, field.TypeJSON)
	}
...
// SetRetentionPolicyJSON sets the "retention_policy_json" field.
func (_u *OrganizationUpdateOne) SetRetentionPolicyJSON(v map[string]interface{}) *OrganizationUpdateOne {
	_u.mutation.SetRetentionPolicyJSON(v)
	return _u
}

// ClearRetentionPolicyJSON clears the value of the "retention_policy_json" field.
func (_u *OrganizationUpdateOne) ClearRetentionPolicyJSON() *OrganizationUpdateOne {
	_u.mutation.ClearRetentionPolicyJSON()
	return _u
}
