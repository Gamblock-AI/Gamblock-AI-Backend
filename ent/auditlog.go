...
func (*AuditLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case auditlog.FieldMetadataJSON:
			values[i] = new([]byte)
		case auditlog.FieldID, auditlog.FieldActorID, auditlog.FieldActorEmail, auditlog.FieldAction, auditlog.FieldTargetType, auditlog.FieldTargetID, auditlog.FieldReason:
