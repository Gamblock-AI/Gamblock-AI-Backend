...
func RetentionPolicyJSONIsNil() predicate.Organization {
	return predicate.Organization(sql.FieldIsNull(FieldRetentionPolicyJSON))
}

// RetentionPolicyJSONNotNil applies the NotNil predicate on the "retention_policy_json" field.
func RetentionPolicyJSONNotNil() predicate.Organization {
	return predicate.Organization(sql.FieldNotNull(FieldRetentionPolicyJSON))
}
