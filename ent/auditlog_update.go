...
func (_u *AuditLogUpdate) SetMetadataJSON(v map[string]interface{}) *AuditLogUpdate {
...
func (_u *AuditLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.MetadataJSON(); ok {
		_spec.SetField(auditlog.FieldMetadataJSON, field.TypeJSON, value)
	}
	if _u.mutation.MetadataJSONCleared() {
		_spec.ClearField(auditlog.FieldMetadataJSON, field.TypeJSON)
	}
...
// SetMetadataJSON sets the "metadata_json" field.
func (_u *AuditLogUpdateOne) SetMetadataJSON(v map[string]interface{}) *AuditLogUpdateOne {
	_u.mutation.SetMetadataJSON(v)
	return _u
}
