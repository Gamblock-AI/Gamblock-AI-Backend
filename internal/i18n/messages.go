...
var messages = map[string]string{
	...
	"standalone_removal_device_not_owned":  "Perangkat ini bukan milik akun Anda.",
	"standalone_removal_partner_active":    "Hubungan pendamping masih aktif; gunakan alur persetujuan pendamping.",
	"standalone_removal_already_active":    "Izin pencopotan masih aktif; tunggu hingga masa berlakunya berakhir.",
	"standalone_removal_sign_unavailable":  "Izin pencopotan tidak dapat diterbitkan saat ini.",
