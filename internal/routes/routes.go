...
func Register(r *gin.Engine, h *handler.Handler, mid *middleware.Middleware) {
	...
	v1.POST("/auth/reauthenticate", mid.AuthRequired(), mid.RateLimitMiddleware("5-M"), h.Reauthenticate)
	...
	admin.GET("/analytics", h.AdminAnalytics)
		...
		admin.POST("/content/learning-hub/items/:id/archive", h.ArchiveAdminLearningHubItem)
